...
class YOLO:
    ...
    def _process_feats(self, out, anchors, mask):
        ...
        # Arguments
            ...
            anchors: List, anchors for box. (6,2)
            mask: List, mask for anchors. (2,3)
        # Returns
        ...
        col = col.reshape(grid_h, grid_w, 1, 2).repeat(3, axis=-2) # (grid_w, grid_w, 3, 1)
    ...
    def _yolo_out(self, outs, shape):
        ...
        # Argument:
            ...
            shape: shape of original image.(1,416,416,3)
        # Returns:
